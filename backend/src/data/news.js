module.exports = [
  {
    ...
    excerpt:
      "Bitcoin traded in a tight range as investors weighed shifting rate expectations and thinner weekend liquidity. Analysts said the next directional move may depend on macro data and ETF flows.",
    content:
  ...
  },
  {
    ...
    excerpt:
      "Ether outperformed as some traders rotated from majors into selective DeFi names. A pickup in DEX volumes added to the narrative of renewed risk-taking.",
    content:
  ...
  },
  {
    ...
    excerpt:
      "Regulators outlined draft guidance aimed at clearer risk disclosures in crypto advertising and influencer promotions. Market participants expect compliance requirements to expand over time.",
    content:
  ...
  },
  {
    ...
    excerpt:
      "ETF flows were mixed as investors rebalanced after recent volatility. Strategists said allocation decisions may hinge on correlations with equities and bonds.",
    content:
  ...
  },
  {
    ...
    excerpt:
      "Activity across the Solana ecosystem improved, from NFT mints to on-chain trading. Still, traders said fundamentals need to translate into sustained spot demand.",
    content:
  ...
  },
  {
    ...
    excerpt:
      "A stronger dollar weighed on risk assets, with crypto consolidating near widely watched levels. Traders said a clean break could trigger faster moves in either direction.",
    content:
  ...
  },
  {
    ...
    excerpt:
      "Stablecoin balances moved across exchanges and on-chain venues as traders repositioned liquidity. Observers said the shifts can foreshadow short-term changes in market activity.",
    content:
      "Stablecoin flows reflected a rotation of liquidity between centralized exchanges and on-chain trading venues. Traders often reposition stablecoins to prepare for volatility, arbitrage, or new listings. While supply changes do not guarantee direction, they can provide context for near-term liquidity conditions. Some desks monitor exchange inflows as a proxy for potential buying power, while outflows can indicate reduced immediate risk appetite. Analysts cautioned that the signal can be noisy around large OTC transfers and custodial movements. Even so, stablecoin dynamics remain a core input for market microstructure watchers.",
  },
];
